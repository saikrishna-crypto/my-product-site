          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-14">
            <div>
              ...
              >
                <img
                  ...
                  referrerPolicy="no-referrer"
                  crossOrigin="anonymous"
                  onError={(e) => { (e.target as HTMLImageElement).src = 'https://via.placeholder.com/400x400/EEEEEE/999999?text=Image+Not+Found'; }}
                />
              </div>
              ...
              {categoryImages.length > 0 ? (
                <>
                  <p className="text-sm font-semibold text-gray-500 uppercase tracking-widest mb-3">
                    {categoryLabels[selectedCategory as keyof typeof categoryLabels]} — Pixelbin Generated
                  </p>
                    ...
                    {categoryImages.map((imgUrl, i) => (
                      ...
                      >
                        <img
                          ...
                          referrerPolicy="no-referrer"
                          crossOrigin="anonymous"
                          onError={(e) => { (e.target as HTMLImageElement).src = 'https://via.placeholder.com/100x100/EEEEEE/999999?text=?'; }}
                        />
                      </div>
                    ))}
                  </div>
                ...
                <div className="flex items-center justify-center h-24 bg-gray-100 rounded-xl border-2 border-dashed border-gray-300">
                  <p className="text-gray-400 text-sm">No {categoryLabels[selectedCategory as keyof typeof categoryLabels]} images yet</p>
                </div>
              )}
            </div>
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
                ...
                <p className="font-bold text-gray-800 text-xl">{categoryLabels[selectedCategory as keyof typeof categoryLabels]}</p>
              ...
              >
                <div className="p-6 pb-2">
                  <img
                    ...
                    referrerPolicy="no-referrer"
                    crossOrigin="anonymous"
                    onError={(e) => { (e.target as HTMLImageElement).src = 'https://via.placeholder.com/300x300/EEEEEE/999999?text=No+Image'; }}
                  />
                </div>
